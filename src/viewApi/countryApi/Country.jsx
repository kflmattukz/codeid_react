...
function Country() {
  ...
  return (
    <div className='mt-5 w-3/5 mx-auto'>
      <button 
        onClick={() => {setCountryEdit({}) ,setShowForm(!showForm)} }
      ...
      { showForm ? countryEdit.countryId ? <CountryForm edit={ countryEdit } /> : <CountryForm /> : <CountryList editCountry={ setCountryEdit } editForm={ setShowForm }  /> }
    </div>
  )
}
